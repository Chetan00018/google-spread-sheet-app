      ...
      <div className="w-full h-[48px] gap-[8px] opacity-100 border-b  pt-[6px] pr-[8px] pb-[6px] pl-[8px] flex flex-row items-center justify-between">
        <div className="flex ">
          <div className="w-[91px] h-[36px] gap-[4px] opacity-100 rounded-[4px] p-[8px] flex flex-row items-center">
            <span
              className="w-[55px] h-[20px] opacity-100 cursor-pointer text-[14px] font-normal leading-[20px] tracking-[0%] text-[#121212] "
              onClick={() => {
                alert("open a toolbar");
              }}
            >
              Tool bar
            </span>
        ...
        <div className="flex w-[437px] h-[36px] gap-[8px] opacity-100 rotate-0">
          <div className="flex flex-row w-[279px] h-[36px] gap-[8px] opacity-100 rotate-0">
            <div
              className="flex flex-row items-center w-[90px] h-[36px] gap-[2px] rounded-[6px] border border-[#EEEEEE] bg-[#FFFFFF] p-[8px] pr-[12px] pl-[8px] opacity-100 relative cursor-pointer"
              onClick={() => {
                alert("import a file");
              }}
            >
            ...
            <div
              className="flex  items-center w-[89px] h-[36px] gap-[4px] rounded-[6px] border border-[#EEEEEE] bg-[#FFFFFF] pr-[12px] pb-[8px] pl-[8px] opacity-100 rotate-0 relative cursor-pointer "
              onClick={() => {
                alert("export an file");
              }}
            >
              <div className="w-5 h-5">
                <img
            ...
            <div
              className="flex items-center  w-[84px] h-[36px] gap-[4px]  rounded-[6px] border border-[#EEEEEE] bg-[#FFFFFF] p-[8px] pr-[12px] pl-[8px] opacity-100 rotate-0 cursor-pointer"
              onClick={() => {
                alert("share a file");
              }}
            >
          ...
          <button
            className="flex items-center gap-[4px] w-full h-[36px] px-[24px] py-[8px] rounded-[6px] bg-[#4B6A4F] opacity-100 cursor-pointer"
            onClick={() => {
              alert("take a new action");
            }}
          >
            <div className="w-5 h-5">
              <img src={shape8} alt="" />
